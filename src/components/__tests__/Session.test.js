...
describe('<Session />', () => {
    const setup = (mode, isStarted, isPaused, minutes, seconds) => {
        const props = {
            mode,
            isStarted,
            isPaused,
            ...
            shortBreakSessionCounter    : 0,
            longBreakSessionCounter     : 0,
    ...
    it('should render <Timer /> and <SessionControls /> components when "mode" is defined', () => {
        const { enzymeWrapper } = setup(sessionModes.WORK, false, false, durationDefaults.WORK, 0);
